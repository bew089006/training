      ...
      <div class="form-group">
        <div class="form-row">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control" id="surname" name="surname" value="{{ old('surname') ? old('surname') : $item->surname }}"  aria-describedby="nameHelp" placeholder="Enter last name">
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" id="mobile" name="mobile" value="{{ old('mobile') ? old('mobile') : $item->mobile}}" a aria-describedby="nameHelp" placeholder="Enter first name">
