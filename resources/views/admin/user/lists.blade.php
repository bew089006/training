            ...
            @foreach($mods as $item)
             <tr>
               ...
               <td>
                        ...
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal_{{$item->name}}_{{ $item->id }}">Delete</button>
                        <!-- Include Delete Modal Confirmation -->
                        @include('admin.layouts.partials.modal-delete', ['url' => 'admin/users', 'name' => $item->name, 'id' => $item->id])
